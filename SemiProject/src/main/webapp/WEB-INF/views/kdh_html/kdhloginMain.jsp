...
<!--로그인-->
  <div class="login-container">
    <form class="login-form" action="/web/login" method="POST">
        ...
        <div class="links">
            <a href="/user/find-id-page">아이디 찾기</a>
...
<div class="signupForm-group">
  ...
  <div class="zipcode-container">
      ...
      <button type="button" class="check-btn" id="send-code-btn">인증하기</button>
      <!-- 경고 메시지 버튼 뒤로 이동 -->
      <div class="error-message">* 필수 입력 사항입니다.</div>
...
<div class="signupForm-group">
  ...
  <input type="text" id="email-code" placeholder="인증번호" required />

  <button type="button"  class="check-btn" id="verify-code-btn">인증</button>
</div><br><br>
<h3>약관 동의</h3>
